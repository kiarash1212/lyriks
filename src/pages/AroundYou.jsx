...
import {useGetTopInTheCountryQuery} from '../redux/services/shazamCore'
...
const AroundYou = () => {
    ...
    useState(() => {
        axios.get('http://ip-api.com/json/').then(r => {
            console.log(r.data.countryCode);
            setCountry(r.data.countryCode)})
    ...
    const {data, isFetching, error} = useGetTopInTheCountryQuery(genreTitle, country)
